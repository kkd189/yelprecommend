...
print("Hi Sadhana, the base directory is ",BASE_DIR)
...
TEMPLATES = [
    {
        ...
        #'DIRS': ['/Users/imac/Desktop/598/Dev/trydjango/src/templates'],   #This is hardcoding - wont work if you are exporting somewhere else
